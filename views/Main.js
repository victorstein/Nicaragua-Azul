...
export default class Main extends Component {
  ...
  async checkUserLoginStatus () {
    ...
    this.setState({
      isUserLoggedIn: (user.provider) || false
    })
    ...
    if ('treasures' in user) {
      if (user.treasures['0'] === 'none') {
        ...
        percentage = user.treasures ? (Object.entries(user.treasures).length / maxTreasure) * 100 : 0
        this.setState({
    ...
    let percentageFiller = percentage * rangeFiller / 100
