...
export default class Caribe extends Component {
  ...
  static navigationOptions ({ navigation }) {
    return {
      ...
      />,
      headerTitle: "Caribe",
      headerStyle: { backgroundColor: "#F44336", height: 70, margin: 0, marginTop: -Constants.statusBarHeight },
  ...
  async componentDidMount(){
    ...
    let wiki = [];
    Object.entries(data.Caribe).forEach((u, i)=>{
      let C = u[0];
          ...
          if("Biodiversidad" in item){
            return(
              <TouchableOpacity
                ...
                onPress={()=>{
                  this.props.navigation.navigate('RenderBioView', {data: 'Caribe', header: 'Biodiversidad', headerBackgroundColor: '#F44336'} );
                }}
              >
                <View style={{ width: '80%', justifyContent: 'center', paddingLeft: 30 }}>
                  <Text style={{ fontSize: 18, }}>Biodiversidad</Text>
                  <Text style={{ fontSize: 14, color: '#BCBEBF' }}>Caribe</Text>
                </View>
            ...
            return(
              <TouchableOpacity
                style={{ flexDirection: 'row', width: '100%', height: helper.height/8 }}
                onPress={()=>{
                  this.props.navigation.navigate('RenderBioView', {data: 'Caribe', header: 'Tortugas Marinas de Nicaragua', headerBackgroundColor: '#F44336'} );
                }}
              >
                <View style={{ width: '80%', justifyContent: 'center', paddingLeft: 30 }}>
