...
export default class Reflexion extends Component {
  ...
  static navigationOptions ({ navigation }) {
    return {
      ...
      />,
      headerTitle: "Reflexión",
      headerStyle: { backgroundColor: "#9E9E9E", height: 70, margin: 0, marginTop: -Constants.statusBarHeight },
  ...
  async componentDidMount(){
    ...
    let wiki = [];
    Object.entries(data.Reflexion).forEach((u, i)=>{
      let C = u[0];
          ...
          if("Biodiversidad" in item){
            return(
              <TouchableOpacity
                ...
                onPress={()=>{
                  this.props.navigation.navigate('RenderBioView', {data: 'Reflexion', header: 'Biodiversidad', headerBackgroundColor: '#9E9E9E'} );
                }}
              >
                <View style={{ width: '80%', justifyContent: 'center', paddingLeft: 30 }}>
                  <Text style={{ fontSize: 18, }}>Biodiversidad</Text>
                  <Text style={{ fontSize: 14, color: '#BCBEBF' }}>Reflexion</Text>
                </View>
            ...
            return(
              <TouchableOpacity
                style={{ flexDirection: 'row', width: '100%', height: helper.height/8 }}
                onPress={()=>{
                  this.props.navigation.navigate('RenderBioView', {data: 'Reflexion', header: 'Especies con regulaciones de pesca', headerBackgroundColor: '#9E9E9E'} );
                }}
              >
                <View style={{ width: '80%', justifyContent: 'center', paddingLeft: 30 }}>
                  <Text style={{ fontSize: 18, }}>Especies con regulaciones de pesca</Text>
                  <Text style={{ fontSize: 14, color: '#BCBEBF' }}>Reflexion</Text>
                </View>
                <View style={{ width: '20%', alignItems: 'center', justifyContent: 'center' }}>
                  <Icon
